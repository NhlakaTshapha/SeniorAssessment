...
begin
    ...
    insert into Log (UpdateDate,Operation)
		...
		',Old Phonenumber was ' +CONVERT(varchar(50),(SELECT Phone_number from deleted)) + (',New Phonenumber is ' + CONVERT(varchar(50),(SELECT Phone_number from inserted))) +
		...
		',Old ID was ' + CONVERT(varchar(50),(SELECT ID_Number from deleted)) + (',New ID is ' + CONVERT(varchar(50),(SELECT ID_Number from inserted))) +
		',Old Account No was ' + CONVERT(varchar(50),(SELECT AccountNumber from deleted)) + (',New Account No is ' + CONVERT(varchar(50),(SELECT AccountNumber from inserted)))
		));
